...
import dskarpetis.elibrary.init.InjecDetachableModel;
...
import dskarpetis.elibrary.ui.InjectorDetachableModel;
import dskarpetis.elibrary.ui.search.SearchPage;

/**
 * Class that defines the LoginPanel
 * 
 * @author dskarpetis
 */
public class LoginPanel extends Panel {
	...
	private final IModel<UserService> serviceModel = new InjecDetachableModel<UserService>(UserService.class, new InjectorDetachableModel());
	...
	public void login() {
		...
		try {
			...
			ElibrarySession.get().login(userLoginData, serviceModel);
